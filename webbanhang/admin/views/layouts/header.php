...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.php?controller=doitac">
            ...
            <li class="nav-item">
                ...
                <div id="collapse" class="collapse" aria-labelledby="heading" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="index.php?controller=banner">Quản Lý Banner</a>
                        <a class="collapse-item" href="index.php?controller=tintuc">Quản Lý Tin Tức</a>
                    </div>
                </div>
            </li>  
